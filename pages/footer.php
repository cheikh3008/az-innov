  ...
  <div class="container-fluid bg-dark footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
      <div class="container py-5">
          <div class="row g-5">
              ...
              <div class="col-lg-3 col-md-6">
                  <h4 class="text-light mb-4">Nous suivre</h4>
                  <div class="d-flex pt-2">
                      <a class="btn btn-square btn-outline-primary me-1" href="#"><i class="fab fa-facebook-f"></i></a>
                      <a class="btn btn-square btn-outline-primary me-1" href="#"><i class="fab fa-instagram"></i></a>
                      <a class="btn btn-square btn-outline-primary me-0" href="#"><i class="fab fa-whatsapp"></i></a>
                  </div>
              </div>
          </div>
      </div>
  ...
  <a href="https://wa.me/+221776514209" target="_blank" class="btn btn-lg btn-lg-square whats">
